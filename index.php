...
<?php include('header.php'); ?>
		...
		<main role="main">
			...
			<div id="main">
				...
				<section class="row section">
					<div class="row-content buffer even clear-after">					
						<div class="section-title"><h3>Novidades e Promoções</h3></div>
						...
						<div class="more-btn"><a class="button transparent aqua" href="#">Ver todos os posts</a></div>						
					</div>	
				</section>	
				...
				<section class="row section">
					<div class="row-content buffer even clear-after">
						<div class="section-title"><h3>Diferenciais</h3></div>
						<p class="centertxt">A Focus Academia está muito feliz em receber sua visita. Esses são alguns de nossos diferenciais , venha logo conhecer. </p>
						<div class="chart" data-percent="100" data-bar-color="#fd685b" data-animate="2000">
							<div class="chart-content">
								<div class="percent"></div>
								<div class="chart-title">Qualificação</div>
							</div><!-- chart-content -->
						</div><!-- chart -->
						<div class="chart" data-percent="100" data-bar-color="#ffce54" data-animate="2500">
							<div class="chart-content">
								<div class="percent"></div>
								<div class="chart-title">Dedicação</div>
							</div><!-- chart-content -->
						</div><!-- chart -->
						<div class="chart" data-percent="100" data-bar-color="#a0d468" data-animate="3000">
							<div class="chart-content">
								<div class="percent"></div>
								<div class="chart-title">Atendimento</div>
							</div><!-- chart-content -->
						</div><!-- chart -->
						<div class="chart" data-percent="100" data-bar-color="#ac92ec" data-animate="3500">
							<div class="chart-content">
								<div class="percent"></div>
								<div class="chart-title">Organização</div>
							</div><!-- chart-content -->
						</div><!-- chart -->
					</div>	
				</section>	
					...
					<div class="row-content buffer even clear-after">
						<div class="testimonial-slider centertxt" data-autoplay="5000" data-pagination="true" data-transition="fade" data-autoheight="false">
							<div class="quote">
								...
								<div class="author">David Bastos</div>
							</div><!-- quote -->
							<div class="quote">
								...
								<div class="author">Alexandre Andrade</div>
							</div><!-- quote -->		
							<div class="quote">
								<p>"There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration."</p>
								<div class="author">Alisson Camara</div>
							</div><!-- quote -->							
				...
				<section class="row section call-to-action">
					<div class="row-content buffer even animation">
						<p>Saiba como entrar em contato, estaremos felizes em atende-lo.</p>
						<a class="button red" href="#">Contato</a>
					</div>
				</section>								

				<section class="row section">
					<div class="map" data-maplat="-3.807590" data-maplon="-38.461147" data-mapzoom="15" data-color="" data-height="22.222" data-img="img/marker.png" data-info="Focus Academia <br> Tel: (85) 34761423"></div>
				</section>									
