				...
				<div class="row-content buffer-left buffer-right buffer-bottom clear-after">
					<div class="column nine">
						<article class="clear-after">
							...
							<p>Desculpe, mas não foi possível encontrar a página que você está procurando. Por favor verifique se você digitou o URL corretamente. Você também pode querer procurar o que você está procurando</p>
						</article>										
					</div><!-- column nine -->
